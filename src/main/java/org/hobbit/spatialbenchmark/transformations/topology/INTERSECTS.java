...
import com.vividsolutions.jts.geom.create.CreateIntersectsGeometryObject;
        ...
        try {
            ...
            if (geo instanceof LineString) {
                ...
                if (line.getCoordinates().length >= 2) {
                    CreateIntersectsGeometryObject instance = new CreateIntersectsGeometryObject(line, type);
